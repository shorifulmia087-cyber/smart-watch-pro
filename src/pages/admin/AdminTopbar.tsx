...
const AdminTopbar = () => {
  ...
  return (
    <header className="h-16 border-b border-border bg-background/80 backdrop-blur-md sticky top-0 z-40 flex items-center justify-between px-4 gap-4">
      ...
      <div className="flex items-center gap-3">
        <div className="hidden md:flex items-center gap-2 bg-muted rounded-xl px-3 py-2 text-sm text-muted-foreground min-w-[220px]">
        ...
        <div className="hidden lg:block text-right">
          ...
          <p className="text-xs font-inter font-medium text-foreground">{formattedTime}</p>
        </div>
      </div>
    </header>
  );
